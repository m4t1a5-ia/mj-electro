...
const WORK_IMAGES = Object.freeze([
  ...
  { src: 'trabajos/03-bano-espejo-colgante.jpg', category: 'Living', title: 'Colgante de cristal y luz indirecta', alt: 'Living con colgante de cristal y luz indirecta detrás del televisor', landscape: true },
  { src: 'trabajos/04-living-iluminacion-decorativa.jpg', category: 'Baño', title: 'Espejo, nicho y luz ambiental', alt: 'Baño completo con espejo LED y nicho con iluminación indirecta', landscape: true },
  { src: 'trabajos/05-living-luz-indirecta.jpg', category: 'Cocina', title: 'Estantes iluminados con LED', alt: 'Estantes de cocina con tiras LED cálidas', landscape: false },
  { src: 'trabajos/06-cocina-tiras-led.jpg', category: 'Living', title: 'Conjunto de colgantes decorativos', alt: 'Living comedor con tres luminarias colgantes decorativas', landscape: true },
  { src: 'trabajos/07-colgantes-living.jpg', category: 'Living', title: 'Luz indirecta en pared de TV', alt: 'Living con iluminación LED indirecta detrás del televisor', landscape: true },
  { src: 'trabajos/08-aplique-bano.jpg', category: 'Baño', title: 'Espejo orgánico retroiluminado', alt: 'Espejo de forma orgánica con retroiluminación LED', landscape: false },
  { src: 'trabajos/09-espejo-led-organico.jpg', category: 'Vestidor', title: 'Iluminación interior de vestidor', alt: 'Vestidor con tiras LED instaladas en el interior', landscape: false },
  { src: 'trabajos/10-vestidor-tiras-led.jpg', category: 'Baño', title: 'Aplique triple sobre espejo', alt: 'Aplique de tres luces instalado sobre el espejo del baño', landscape: false },
  ...
  { src: 'trabajos/12-bano-iluminacion-calida.jpg', category: 'Baño', title: 'Nicho iluminado sobre bañera', alt: 'Baño con bañera exenta y nicho iluminado con LED', landscape: true },
  { src: 'trabajos/13-bano-nicho-iluminado.jpg', category: 'Baño', title: 'Espejo circular y colgante globo', alt: 'Espejo circular retroiluminado con colgante esférico', landscape: false },
  { src: 'trabajos/14-bano-espejo-circular.jpg', category: 'Baño', title: 'Iluminación integral con colgante', alt: 'Vista completa de baño con espejo y colgante iluminados', landscape: false },
  { src: 'trabajos/15-bano-colgante-deco.jpg', category: 'Baño', title: 'Espejo circular retroiluminado', alt: 'Espejo circular de baño con luz LED posterior y colgante', landscape: false },
  { src: 'trabajos/16-colgante-cristal.jpg', category: 'Baño', title: 'Espejo LED con globo de luz', alt: 'Espejo LED circular con luminaria esférica colgante', landscape: false },
  { src: 'trabajos/17-espejo-led-y-globo.jpg', category: 'Baño', title: 'Spots embutidos en cielorraso', alt: 'Baño en instalación con spots LED embutidos', landscape: false },
  { src: 'trabajos/18-bano-spots-embutidos.jpg', category: 'Living', title: 'Colgante de cristal protagonista', alt: 'Lámpara colgante de cristal instalada en el living', landscape: false },
  { src: 'trabajos/19-bano-colgante-triple.jpg', category: 'Baño', title: 'Colgante globo instalado', alt: 'Luminaria colgante esférica instalada en baño', landscape: false },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const isMediaDialogOpen = (dialog) => Boolean(dialog?.open || dialog?.classList.contains('is-fallback-open'));
  const openMediaDialog = (dialog) => {
    if (!dialog) return;
    ...
    if (typeof dialog.showModal === 'function') {
      try {
        ...
        // Continue with the CSS fallback used by older or embedded browsers.
      }
    }
    dialog.setAttribute('open', '');
    dialog.classList.add('is-fallback-open');
  };
  const closeMediaDialog = (dialog) => {
    if (!dialog) return;
    if (typeof dialog.close === 'function' && dialog.open) {
      try {
        dialog.close();
      } catch (error) {
        // Removing the open attribute below closes the fallback safely.
      }
    }
  ...
  const closeProductDialog = () => {
    ...
    closeMediaDialog(productDialog);
  };
  ...
  document.addEventListener('keydown', (event) => {
    if (!isMediaDialogOpen(productDialog)) return;
  ...
  workDialogClose?.addEventListener('click', () => closeMediaDialog(workDialog));
  ...
  workDialog?.addEventListener('click', (event) => {
    if (event.target === workDialog) closeMediaDialog(workDialog);
  });
  workDialog?.addEventListener('close', () => {
    document.body.classList.remove('modal-open');
  });
  document.addEventListener('keydown', (event) => {
    if (!isMediaDialogOpen(workDialog)) return;
    if (event.key === 'Escape') closeMediaDialog(workDialog);
